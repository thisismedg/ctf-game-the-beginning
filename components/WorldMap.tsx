...
const WorldMap = () => {
    ...
    useEffect(() => {
        ...
        const changeCircleColor = () => {
            // Pick random circle
            const randomCircle =
                circleArray[Math.floor(Math.random() * circleArray.length)];
    
            // Save original fill color
            const originalFill = randomCircle.getAttribute("fill");
    
            // Change to random color
            randomCircle.setAttribute("fill", "#FF0035");
    
            // After some time, revert to original color
            setTimeout(() => {
                randomCircle.setAttribute("fill", originalFill);
            }, 1000);
        };
